...
def mk_groove():
    ...
    return sweep_result, cutter_entry_shape, entry_point
...
if ("show_object" in locals()) or (__name__ == "__main__"):
    sweep_result, cutter_entry_shape, entry_point = mk_groove()
