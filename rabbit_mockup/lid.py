...
try:
    ...
    sys.path.append(pathlib.Path(__file__).parent.joinpath(["src", "geometrics"]))
    import geometrics.toolbox as tb
    from geometrics.toolbox.twod_to_threed import TwoDToThreeD
...
# substrate array
substrate_array_l = 55
substrate_array_w = 55
